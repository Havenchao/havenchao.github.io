...
/**
 * Menu Transion Library.
 */

var $main = $( '#page-main' ),
    $pages = $main.children( 'div.rmt-page' ),
    $iterate = $( '#page-swap' ),
...
$pages.eq( current ).addClass( 'rmt-page-current' );
...
function resetPage( $outpage, $inpage ) {
    ...
    $inpage.attr( 'class', $inpage.data( 'originalClassList' ) + ' rmt-page-current' );
}
...
function loadNextPage() {
    ...
    var $nextPage = $pages.eq( current ).addClass( 'rmt-page-current' ),
        outClass = 'elrm-page-rotatePushRight', inClass = 'elrm-page-rotatePullLeft elrm-page-delay180';
...
function loadPreviousPage() {
    ...
    var $prevPage = $pages.eq( current ).addClass( 'rmt-page-current' ),
        outClass = 'elrm-page-rotatePushLeft', inClass = 'elrm-page-rotatePullRight elrm-page-delay180';
...
function gotoPage3(pagenumber) {
    ...
    if(current == pagenumber) {return true;}
        ...
        var $prevPage = $pages.eq( current ).addClass( 'rmt-page-current' ),
            outClass = 'elrm-page-rotatePushTop', inClass = 'elrm-page-rotatePullBottom elrm-page-delay180';
...
function gotoPage4(pagenumber) {
    ...
    if(current == pagenumber) {return true;}
        ...
        var $prevPage = $pages.eq( current ).addClass( 'rmt-page-current' ),
            outClass = 'elrm-page-rotatePushBottom', inClass = 'elrm-page-rotatePullTop elrm-page-delay180';
